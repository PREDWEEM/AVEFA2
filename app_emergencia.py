...
st.sidebar.caption("Histórico BORDE2025.csv se carga automáticamente desde GitHub; futuro desde meteo_history.csv público.")
...
# ====================== EMPALME: histórico GitHub + futuro (meteo_history.csv) ======================
